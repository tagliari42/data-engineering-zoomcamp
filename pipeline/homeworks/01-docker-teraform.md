...
Answer: We can use either db:5432 or postgres:5432
...
WHERE lpep_pickup_datetime BETWEEN '2025-11-01' AND '2025-12-01' AND
	  trip_distance <= 1;
...
SELECT total, "Zone"
FROM (SELECT SUM(t."total_amount") AS total, z."Zone"
FROM public.green_taxi_trips AS t JOIN zones AS z
...
SELECT t."tip_amount" AS total_tip, zpu."Zone" AS pickup_zone,	zdo."Zone" AS dropoff_zone
